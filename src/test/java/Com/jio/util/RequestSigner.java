...
public class RequestSigner {
    ...
    public String encodeRfc3986(String urlEncodedString) {
        if (urlEncodedString == null) {
            return RequestSigner.Fields.EMPTY_STRING;
        }
        try {
    ...
    public String getDateTime() {
        if (nowDateTime == null) {
            ...
            nowDateTime = nowAsISO.replace("-", RequestSigner.Fields.EMPTY_STRING).replace(RequestSigner.Fields.COLON, RequestSigner.Fields.EMPTY_STRING)
                    .replace("'", RequestSigner.Fields.EMPTY_STRING);
        }
        return nowDateTime;
    }
    ...
    public String generateCanonicalString() throws NoSuchAlgorithmException {
        ...
        if (!body.equals(Fields.EMPTY_STRING)) {
            ...
            canonicalRequest.append(hash(RequestSigner.Fields.EMPTY_STRING));
        }
    ...
    public String getCanonicalHeaders(Map<String, String> headers) {
        StringBuilder canonicalHeaderKeyStringBuilder = new StringBuilder(RequestSigner.Fields.EMPTY_STRING);
        StringBuilder canonicalHeaderValueStringBuilder = new StringBuilder(RequestSigner.Fields.EMPTY_STRING);
        ...
        for (String s : sortedHeadersMap.keySet()) {
            ...
            canonicalHeaderKeyStringBuilder.append(RequestSigner.Fields.COLON);
    ...
    public String canonicalQueryString() {
        StringBuilder canonicalQueryString = new StringBuilder(RequestSigner.Fields.EMPTY_STRING);
        ...
        for(String s:sortedQueryParam.keySet()){
            ...
            canonicalQueryString.append(RequestSigner.Fields.EQUALS);
